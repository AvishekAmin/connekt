...
export default function MeetingControls({
  ...
  return (
    <div className="py-3 px-4 flex items-center justify-center shrink-0 z-30 select-none">
      <div className="inline-flex items-center gap-2.5 sm:gap-3.5 px-4 sm:px-6 py-2 rounded-full bg-[#141414]/95 backdrop-blur-xl border border-white/10 shadow-2xl shadow-black">
        <button
          type="button"
        ...
        <div className="relative">
          ...
          {!isChatOpen && unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 size-5 bg-gradient-to-r from-[#00D8F6] to-[#7B61FF] text-black font-bold rounded-full text-[10px] flex items-center justify-center border-2 border-[#141414] pointer-events-none animate-bounce">
